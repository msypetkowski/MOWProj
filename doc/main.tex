...
Using k-means algorithm (k=2) with initial centers in (3,3) and (1,1), we got clustering as shown on figure \ref{fig:clust}.
...
\begin{figure}[h]
    \caption[]{Clustering with k-means algorithm. (1: drinking, 2: non-drinking)}
    \centering
...
\begin{figure}[h]
    \caption[]{Clustering with k-means algorithm (1: drinking, 2: non-drinking). Importance of Dalc attribute increased.}
    \centering
