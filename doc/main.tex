...
(33\% for single trees, and 30\% for ramdom forests).


\section{Conclusion}
Random forests doesn't perform well on this dataset.
Results are slightly better than single decision trees --
single trees achieve around 33\% accuracy, and random forests 30\%.
