...
\begin{figure}[H]
    \centering
    \includegraphics[page=3,width=0.5\textwidth]{../Rplots.pdf}
    \label{fig:clust2}
...
\begin{figure}[H]
    \centering
    \includegraphics[page=7,width=0.5\textwidth]{../Rplots.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim={2cm 2cm 2cm 2cm},clip,page=4,width=0.5\textwidth]{../Rplots.pdf}
    \label{fig:single}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim={0 0 0 2cm},clip,page=5,width=0.5\textwidth]{../Rplots.pdf}
